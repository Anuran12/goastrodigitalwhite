...
export default function Header() {
    ...
    return (
        <>
            <header className='w-full work-sans absolute mt-2 z-50 overflow-x-clip'>
                {hideNav ? (
                    <nav className={`${styles.maxWidthNav} py-6 2xl:px-0 px-4 flex justify-between items-center`}>
                        ...
                        <div className="logo">
                            ...
                            >
                                <img src={NewLogo} alt="Astro Digital Marketing" className='cursor-pointer md:w-40 relative z-[1]' />
                            </a>
                        </div>
