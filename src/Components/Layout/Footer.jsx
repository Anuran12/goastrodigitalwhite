      ...
      <footer className='bg-mid-night w-full work-sans'>
        <div className={`${styles.maxWidth} pt-14 2xl:px-0 md:px-4 px-8`}>
              ...
              <div className='sm:text-left md:gap-y-1 gap-y-2 sm:w-auto'>
                ...
                <div className='flex flex-col gap-y-6'>
                  <div className='flex items-center justify-start pt-8 sm:pt-6'>
                    <Link to="tel:(323) 595 3041" className='flex items-center justify-start'>
                      <Icon icon="mdi:phone-outline" className='text-xl' />
                      <p className=' relative'>
                        <span className='text-base md:text-lg pl-2 pr-4'>(323) 595 3041</span>
                        <span className='border border-neal-blue rounded py-1 px-2'>Call or Text Us!</span>
                      </p>
                    </Link>
                  </div>
                  <div className='flex items-center justify-start'>
                    <Link to="https://maps.app.goo.gl/didhjN2Krf7UNXWv5" target='_blank' className='flex items-start justify-start transition-all group'>
                      <Icon icon="mingcute:location-line" className='text-xl transition-all duration-200 mt-1' />
                      <p className='text-base pl-2 pr-4 transition-all duration-200 w-full max-w-64'>20555 DEVONSHIRE ST #360 LOS ANGELES, CA 91311
                      </p>
                    </Link>
                  </div>
                </div>
          ...
          <div>
            ...
            <p className='text-sm text-[#868686] text-center pb-4'>All Rights Reserved - Astro Digital Marketing LLC - Privacy Statement</p>
          </div>
        </div>
      </footer>
    </>
